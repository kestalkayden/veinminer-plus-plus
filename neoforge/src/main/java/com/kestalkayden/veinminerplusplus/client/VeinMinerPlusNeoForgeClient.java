 ...
 * <p>Responsibilities:
 * <ol>
 *   <li>Register the four key mappings (under a string category) via {@link RegisterKeyMappingsEvent}.
...
public final class VeinMinerPlusNeoForgeClient {
     ...
     * removed on this branch, so the payload is wrapped in a {@link ServerboundCustomPayloadPacket}
